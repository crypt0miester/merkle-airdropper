...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const tokenMint = yield (0, utils_1.createMint)(provider, provider.publicKey, token_1.TOKEN_PROGRAM_ID);
        /*
        ...
        const withdrawIxn = yield merkleAirdropProgram.methods
            .withdrawFromVault((0, utils_1.toBytes32Array)(merkleRoot))
            .accounts({
            authority: provider.publicKey,
            authorityMintAta: (0, token_1.associatedAddress)({
                mint: tokenMint,
                owner: provider.publicKey,
            }),
            tokenMint,
